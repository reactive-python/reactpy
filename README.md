...
IDOM is a Python micro-framework that links your web project to a ReactJS front-end, allowing you to create **interactive websites without needing JavaScript!**
