...
!!! info "Deep Dive"
    ...
    <font size="4">**Displaying many visual states at once**</font>
...
!!! info "Deep Dive"
    ...
    <font size="4">**Eliminating “impossible” states with a reducer**</font>
...
=== "1. Add and remove a CSS class"
    ...
    <font size="4">**Challenge 1 of 3: Add and remove a CSS class**</font>
    ...
    === "picture.py"
        ...
        ```python
        {% include "../../examples/managing_state/picture_component.py" start="# start" %}
        ```
...
=== "2. Profile editor"
    ...
    <font size="4">**Challenge 2 of 3: Profile editor**</font>
...
=== "3. Refactor the imperative solution without React"
    ...
    <font size="4">**Challenge 3 of 3: Refactor the imperative solution without React**</font>
