...
if sys.platform == "win32" and sys.version_info[:2] == (3, 7):
    # We need this due to a bug in Python on Windows related to shutil.rmtree(). Because
    # tempfile.TemporaryDirectory() calls shutil.rmtree we have to re-implement it with
    # pathlib functions instead.
    #
    # See here for more info: https://bugs.python.org/issue31226
