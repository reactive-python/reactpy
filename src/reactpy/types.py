...
class _CssStyleDict(TypedDict, total=False):
...
# TODO: Enable `extra_items` on `_CssStyleDict` when PEP 728 is merged, likely in Python 3.14. Ref: https://peps.python.org/pep-0728/
CssStyleDict = _CssStyleDict | dict[str, Any]
...
# TODO: Enable `extra_items` on `_VdomAttributes` when PEP 728 is merged, likely in Python 3.14. Ref: https://peps.python.org/pep-0728/
